...
export  const isValidStartTime = (value) => typeof value === 'number' && value>0 && Math.floor(value) === value;
        ...
        <div className={classes.timerContainer}>
            <div className={classes.addTimeInputContainer}>
                <TextField
                    ...
                    fullWidth
                />
                <Button variant="outlined" color="primary" onClick={() => setTimerDetails([...timerDetails, {id: createUUID(), startTime}])} disabled={shouldButtonDisable}>
                    Add Timer
                </Button>
            </div>
        </div>
